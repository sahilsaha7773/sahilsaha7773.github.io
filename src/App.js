...
class App extends React.Component {
  ...
  render(){
    ...
    return (
      ...
      {/* <Box display="flex" style={{marginTop: 20, float: "right", marginRight: 20, alignItems: "center"}}>
        <Switch
      ...
      <Grid direction="column" container style={{marginTop: 40, textAlign:'center', justifyContent: 'center' }} justify="center" alignItems="center">
        <div className="App">
          <CssBaseline />
            <Avatar alt="Sahil Saha" src={myimg} style={{width: 100, height: 100, marginLeft: 'auto', marginRight: 'auto'}} className="main__image"/>
            ...
            <div style={{padding: "20px", spaceBetween: "20px"}}>
            <Button style={styles.btn} className="btn" variant="contained" color="primary" onClick={(e)=>this.handleClick(e, "skills")} >
              <Memory/>
              Skills
            </Button>
            <Button style={styles.btn} className="btn" variant="contained" color="secondary" onClick={(e)=>this.handleClick(e, "education")} >
              <School />
              Education
            </Button>
            <Button style={styles.btn} className="btn" variant="contained" color="primary" onClick={(e)=>this.handleClick(e, "awards")}>
              <Code/>
              Awards
            </Button>
            <Button style={styles.btn} className="btn" variant="contained" color="secondary" onClick={(e)=>this.handleClick(e, "certifications")}>
              <School />
              Certifications
            </Button>
